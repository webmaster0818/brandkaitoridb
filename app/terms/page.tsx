...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-5 py-12 md:py-16">
      ...
      <h1 className="rule-gold text-2xl md:text-3xl text-ink mb-8">利用規約</h1>
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">1. 掲載情報について</h2>
        <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
          <p>
            当サイトは、ブランド買取に関する情報提供・比較を行う情報メディアであり、買取サービスの提供・査定・仲介は行っていません。
          </p>
          <p>
            当サイトに掲載する情報は、実売データおよび各社公式サイトの公開情報・当社の調査に基づいて作成していますが、その完全性・正確性・最新性・有用性を保証するものではありません。相場は市況により変動し、各社のサービス内容・手数料などは予告なく変更されることがあります。
          </p>
          <p>
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">2. リンク先サービスの利用</h2>
        <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
          <p>
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">3. 著作権</h2>
        <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
          <p>
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">4. 禁止事項</h2>
        <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">5. 免責事項</h2>
        <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
          <p>
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">6. 規約の変更</h2>
        <p className="text-[0.92rem] leading-loose text-ink-soft">
      ...
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">7. 準拠法</h2>
        <p className="text-[0.92rem] leading-loose text-ink-soft">
          本規約の解釈および当サイトの利用に関しては、日本法を準拠法とします。
        </p>
      </section>

      <p className="mt-12 text-[0.85rem] text-muted">制定日：2026年8月10日</p>

      <div className="mt-8 flex flex-wrap gap-4">
        <a href="/about/" className="btn-line">
          運営者情報
        </a>
        <a href="/privacy/" className="btn-line">
          プライバシーポリシー
        </a>
      </div>
    </main>
