...
export const metadata: Metadata = {
  title: "ブランド品の売り方ガイド",
  description:
    "ブランド品を初めて売る人のための実務ガイド。相場を知る、業者を絞る、相見積もりで決めるという全体の流れと、買取方法の違い・訪問購入のクーリングオフ・腕時計とバッグの品目別実務ガイドを案内します。",
...
const guides = [
  ...
  },
  {
    eyebrow: "WATCH",
    title: "腕時計を高く売る実務",
    body: "付属品・リファレンス・動作状態など査定を左右する点と、実売相場データ、時計を公式に取り扱う業者への導線を1本にまとめました。",
    href: "/guide/watch/",
  },
  {
    eyebrow: "BAG",
    title: "バッグを高く売る実務",
    body: "付属品・刻印・状態の見方と、アイコンバッグの実売相場データ、バッグを公式に取り扱う業者への導線をまとめた実務ガイドです。",
    href: "/guide/bag/",
  },
  {
    eyebrow: "WALLET",
    title: "財布を高く売る実務",
    body: "13ブランドの財布の実売相場をひとつの表にまとめ、財布の査定で見られる点と、財布を公式に取り扱う業者を整理しました。",
    href: "/guide/wallet/",
  },
  {
    eyebrow: "SHOES",
    title: "靴・スニーカーを高く売る実務",
    body: "10ブランドの靴・スニーカーの実売相場と、ソール・箱・新品中古差など靴特有の査定ポイント、靴を公式に扱う業者をまとめました。",
    href: "/guide/shoes/",
  },
  {
    eyebrow: "NO BOX",
    title: "箱なし・付属品なしで売る",
    body: "箱・保存袋・ギャランティがない品の扱いを、買取業者18社の公式記載を原文で照合。付属品の役割と申込み前の確認点を整理しました。",
    href: "/guide/no-box/",
  },
  {
    eyebrow: "DAMAGED",
    title: "傷・使用感のある品を売る",
    body: "角スレ・ベタつき・壊れた時計など状態の悪い品を売れるか、18社の公式記載で照合。減額されやすい箇所と、やってはいけないことをまとめました。",
    href: "/guide/damaged/",
  },
  {
    eyebrow: "NOT ACCEPTED",
    title: "買取不可になるもの",
    body: "コピー品・盗品・著しい破損・付属品のみ・ローン残債など、18社が公式に「買取できない」とする条件を照合し、断られたときの選択肢を整理しました。",
    href: "/guide/not-accepted/",
  },
];
