...
export default function ContactPage() {
  return (
    <main className="mx-auto max-w-3xl px-5 py-12 md:py-16">
      ...
      {/* 利用者の方へ */}
      <section className="mt-12">
        <h2 className="rule-gold text-xl text-ink mb-6">利用者の方へ</h2>
        <div className="card-lux p-7">
          <div className="space-y-4 text-[0.92rem] leading-loose text-ink-soft">
            <p>
              当サイトはブランド買取の比較情報メディアであり、買取サービスの提供・査定・仲介は行っていません。そのため、次のようなお問い合わせにはお答えできません。
            </p>
